      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.card}>
            <img src={assetPath(advantage1)} alt="Analytics icon" className={styles.cardIcon}/>
          ...
          {/* Вторая карточка */}
          <div className={styles.card}>
            <img src={assetPath(advantage2)} alt="Products icon" className={styles.cardIcon}/>
          ...
          {/* Третья карточка */}
          <div className={styles.card}>
            <img src={assetPath(advantage3)} alt="Dashboard icon" className={styles.cardIcon}/>
