  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: (
        <p className={styles.answerText}>
          Да! Например:<br />
          1. «Маржинальность по категориям» с учетом логистики<br />
    ...
    },
    {
      ...
      answer: (
        <div>
          <p className={styles.answerText}>
            Самое тяжелое в аналитике — последствия решений, принятых на основе ложных данных.<br />
            Данные у нас обрабатываются алгоритмами. Если произойдет какая-то ошибка, то она точно<br />
